...
ax.text(0.9,0.9,"M={}".format(deg_index),ha='right',va='top',transform=ax.transAxes,fontsize=Font_size)
ax.text(1.65,1,r"$\alpha$={:.1e}".format(optimal_model.alpha),ha='right',va='top',transform=ax.transAxes,fontsize=13)
ax.text(1.65,0.85,r"$\beta$={:.1e}".format(optimal_model.beta),ha='right',va='top',transform=ax.transAxes,fontsize=13)
plt.tight_layout()
